...
import { FileText, Code2, PenTool, File, Video, type LucideIcon } from 'lucide-react';
...
const typeOptions: { id: InstanceType; label: string; description: string; icon: LucideIcon }[] = [
  ...
  { id: 'lecture', label: 'Lecture', description: 'Capture lectures from video, audio, or slides.', icon: Video },
];
