...
This module provides simple, direct code generation using Claude API.
For advanced code generation with the 6-agent pipeline, see enhanced_codegen.py.
"""
...
# These are now imported from validation module above
call_claude_to_fix_manim_code = repair_code_with_claude
